...
# establecemos la frecuencia de las salidas pr ancho de pulso
servo1.freq(50)
servo2.freq(50)
servo3.freq(50)
servo4.freq(50)

#establecemos un diccionario que mapea las salidas con un tópico del MQTT
servomotores = {
...
try:
    ...
    Reinciar_conexion()
#iniciamos un bucle infinito para revisar si hay mensajes, y en el caso que haya
while True:
